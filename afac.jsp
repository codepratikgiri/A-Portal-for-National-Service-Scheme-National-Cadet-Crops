    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="afac.jsp" class="nav-link">Faculty</a></li>
          <li class="nav-item"><a href="astu.jsp" class="nav-link">Students</a></li>
      ...
      <div class="container-fluid">
        <div class="slider-text d-md-flex align-items-center" data-scrollax-parent="true">
          ...
          <div class="one-forth pr-md-4 ftco-animate align-self-md-center" data-scrollax=" properties: { translateY: '70%' }">
          	<h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Faculty Details</h1>
    ...
    <section class="ftco-section services-section">
      <div class="container">
        <div>
		  ...
		  ResultSet rs=st.executeQuery(" select * from reg where role='faculty' ");
		  while(rs.next()){%>
			  <tr>
