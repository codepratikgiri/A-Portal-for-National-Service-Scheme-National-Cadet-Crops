...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a href="index.html"><p style="font-size:30px;font-family:Garamond;"><b>NSS/NCC</b></p></a>
      ...
      <div class="container">
        ...
        <div class="row block-9">
          <div class="col-md-6 pr-md-5">
            <form action="stureg1.jsp" method="post" name="formReg" >
              ...
              <div class="form-group">
                <input type="password" class="form-control" placeholder="Your Password" name="pwd" required>
              </div>
			  <div class="form-group">
                <input type="number" class="form-control" placeholder="Your Phone Number" name="phn" required>
              </div>
			  <div class="form-group">
                <input type="text" class="form-control" placeholder="Your College ID" name="cid" required>
              </div>
			  <div class="form-group">
			...
			<br>
		  <h3>Login!!!<a href="login.jsp"> Click Here</a></h3>
          </div>

          <div class="col-md-6"><img src="images/stureg.jpg" alt="Student Registration" style="margin-left: 100px;"></div>
        </div>
      </div>
    </section>
