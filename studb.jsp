    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="studb.jsp" class="nav-link">Notification</a></li>
    ...
    <section class="ftco-section services-section">
      <div class="container">
        <div>
		  ...
		  <th><center>Faculty ID</center></th>
		  </tr>
		  <%@include file="dbcon.jsp"%>
		  <%
		  String afs=(String)session.getAttribute("afs");
		  Statement st=con.createStatement();
		  ResultSet rs=st.executeQuery(" select * from notification where fid='"+afs+"' ");
		  while(rs.next()){
			  %>
			  <tr>
