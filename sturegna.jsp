          ...
          <div class="col-md-6 pr-md-5">
            <!--<form action="login1.jsp" method="post">
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Your ID" name="name" required>
              </div>
              <div class="form-group">
			...
			<br>
			<h3>Your application request is in process. You can login after the approval.</h3>
		  <h3>Thank You!!!<a href="index.html">Click Here To Go Back</a></h3>
		  <!--<h3>Student<a href="stureg.jsp"> Click Here to Register</a></h3>-->
          </div>

          <div class="col-md-6"><img src="images/wait.gif" alt="Under Process" style="margin-left: 100px;"></div>
        </div>
      </div>
    </section>
